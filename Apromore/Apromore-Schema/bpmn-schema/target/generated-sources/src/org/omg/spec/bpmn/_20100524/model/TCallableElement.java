...
/**
 * <p>tCallableElement complex type的 Java 类。
 * 
    ...
    implements Visitable
{
    ...
    @XmlElement(type = QName.class)
    protected List<TInterface> supportedInterfaceRef;
     ...
     * 
     */
    public List<TInterface> getSupportedInterfaceRef() {
        if (supportedInterfaceRef == null) {
            supportedInterfaceRef = new ArrayList<TInterface>();
        }
