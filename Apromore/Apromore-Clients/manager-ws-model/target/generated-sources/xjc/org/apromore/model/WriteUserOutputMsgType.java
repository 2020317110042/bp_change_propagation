...
/**
 * <p>WriteUserOutputMsgType complex type的 Java 类。
 * 
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof WriteUserOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final WriteUserOutputMsgType that = ((WriteUserOutputMsgType) object);
        {
            UserType lhsUser;
