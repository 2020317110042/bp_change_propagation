...
/**
 * <p>ParametersType complex type的 Java 类。
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="Parameter" type="{urn:qut-edu-au:schema:apromore:manager}ParameterType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ParametersType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ParametersType that = ((ParametersType) object);
        {
            List<ParameterType> lhsParameter;
            lhsParameter = this.getParameter();
            List<ParameterType> rhsParameter;
