...
/**
 * <p>GetWorkspaceFolderTreeOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="GetWorkspaceFolderTreeOutputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "GetWorkspaceFolderTreeOutputMsgType", propOrder = {
    "result",
    "folders"
})
public class GetWorkspaceFolderTreeOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetWorkspaceFolderTreeOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetWorkspaceFolderTreeOutputMsgType that = ((GetWorkspaceFolderTreeOutputMsgType) object);
        {
