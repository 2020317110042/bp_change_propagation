...
/**
 * <p>DeleteProcessVersionsOutputMsgType complex type的 Java 类。
 * 
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DeleteProcessVersionsOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DeleteProcessVersionsOutputMsgType that = ((DeleteProcessVersionsOutputMsgType) object);
        {
