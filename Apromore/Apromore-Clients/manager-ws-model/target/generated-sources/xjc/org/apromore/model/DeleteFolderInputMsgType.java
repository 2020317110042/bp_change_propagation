...
/**
 * <p>DeleteFolderInputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="DeleteFolderInputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "DeleteFolderInputMsgType")
public class DeleteFolderInputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DeleteFolderInputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DeleteFolderInputMsgType that = ((DeleteFolderInputMsgType) object);
        {
            Integer lhsFolderId;
