...
/**
 * <p>GetProcessGroupsInputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="GetProcessGroupsInputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "GetProcessGroupsInputMsgType")
public class GetProcessGroupsInputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetProcessGroupsInputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetProcessGroupsInputMsgType that = ((GetProcessGroupsInputMsgType) object);
        {
