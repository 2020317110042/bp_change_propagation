...
/**
 * <p>ProcessVersion_idsType complex type的 Java 类。
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="ProcessVersion_id" type="{urn:qut-edu-au:schema:apromore:manager}ProcessVersion_idType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            List<ProcessVersionIdType> theProcessVersionId;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ProcessVersionIdsType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ProcessVersionIdsType that = ((ProcessVersionIdsType) object);
        {
            List<ProcessVersionIdType> lhsProcessVersionId;
            lhsProcessVersionId = this.getProcessVersionId();
            List<ProcessVersionIdType> rhsProcessVersionId;
