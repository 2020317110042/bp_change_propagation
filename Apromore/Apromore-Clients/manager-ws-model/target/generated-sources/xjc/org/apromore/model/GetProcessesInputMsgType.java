...
/**
 * <p>GetProcessesInputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="GetProcessesInputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "GetProcessesInputMsgType")
public class GetProcessesInputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetProcessesInputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetProcessesInputMsgType that = ((GetProcessesInputMsgType) object);
        {
            String lhsUserId;
