...
/**
 * <p>GetGedMatrixSummaryInputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="GetGedMatrixSummaryInputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "GetGedMatrixSummaryInputMsgType")
public class GetGedMatrixSummaryInputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetGedMatrixSummaryInputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetGedMatrixSummaryInputMsgType that = ((GetGedMatrixSummaryInputMsgType) object);
        {
            String lhsEmpty;
