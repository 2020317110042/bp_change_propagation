...
/**
 * <p>RemoveProcessPermissionsOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="RemoveProcessPermissionsOutputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "RemoveProcessPermissionsOutputMsgType", propOrder = {
    "result"
})
public class RemoveProcessPermissionsOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RemoveProcessPermissionsOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final RemoveProcessPermissionsOutputMsgType that = ((RemoveProcessPermissionsOutputMsgType) object);
        {
