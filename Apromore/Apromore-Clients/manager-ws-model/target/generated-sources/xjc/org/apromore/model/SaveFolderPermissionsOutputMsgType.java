...
/**
 * <p>SaveFolderPermissionsOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="SaveFolderPermissionsOutputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "SaveFolderPermissionsOutputMsgType", propOrder = {
    "result"
})
public class SaveFolderPermissionsOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SaveFolderPermissionsOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SaveFolderPermissionsOutputMsgType that = ((SaveFolderPermissionsOutputMsgType) object);
        {
