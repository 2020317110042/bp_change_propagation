...
/**
 * <p>ReadDeploymentPluginInfoInputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ReadDeploymentPluginInfoInputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "ReadDeploymentPluginInfoInputMsgType")
public class ReadDeploymentPluginInfoInputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ReadDeploymentPluginInfoInputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ReadDeploymentPluginInfoInputMsgType that = ((ReadDeploymentPluginInfoInputMsgType) object);
        {
