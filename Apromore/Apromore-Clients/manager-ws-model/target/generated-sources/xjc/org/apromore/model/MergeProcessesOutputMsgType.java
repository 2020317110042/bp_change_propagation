...
/**
 * <p>MergeProcessesOutputMsgType complex type的 Java 类。
 * 
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MergeProcessesOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final MergeProcessesOutputMsgType that = ((MergeProcessesOutputMsgType) object);
        {
