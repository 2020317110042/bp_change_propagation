...
/**
 * <p>DeleteFolderOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="DeleteFolderOutputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "DeleteFolderOutputMsgType", propOrder = {
    "result"
})
public class DeleteFolderOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DeleteFolderOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DeleteFolderOutputMsgType that = ((DeleteFolderOutputMsgType) object);
        {
