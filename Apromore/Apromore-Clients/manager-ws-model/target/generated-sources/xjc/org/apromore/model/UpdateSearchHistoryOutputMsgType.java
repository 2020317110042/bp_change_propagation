...
/**
 * <p>UpdateSearchHistoryOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="UpdateSearchHistoryOutputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "UpdateSearchHistoryOutputMsgType", propOrder = {
    "result"
})
public class UpdateSearchHistoryOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UpdateSearchHistoryOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UpdateSearchHistoryOutputMsgType that = ((UpdateSearchHistoryOutputMsgType) object);
        {
