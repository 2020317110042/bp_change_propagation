...
/**
 * <p>ReadCanoniserInfoOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ReadCanoniserInfoOutputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "ReadCanoniserInfoOutputMsgType", propOrder = {
    "result",
    "pluginInfo"
})
public class ReadCanoniserInfoOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ReadCanoniserInfoOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ReadCanoniserInfoOutputMsgType that = ((ReadCanoniserInfoOutputMsgType) object);
        {
