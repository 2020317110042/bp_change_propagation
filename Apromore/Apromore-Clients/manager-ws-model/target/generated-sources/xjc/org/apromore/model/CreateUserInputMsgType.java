...
/**
 * <p>CreateUserInputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="CreateUserInputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "CreateUserInputMsgType", propOrder = {
    "user"
})
public class CreateUserInputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CreateUserInputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CreateUserInputMsgType that = ((CreateUserInputMsgType) object);
        {
            UserType lhsUser;
