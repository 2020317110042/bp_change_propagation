...
/**
 * <p>RemoveFolderPermissionsInputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="RemoveFolderPermissionsInputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "RemoveFolderPermissionsInputMsgType")
public class RemoveFolderPermissionsInputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RemoveFolderPermissionsInputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final RemoveFolderPermissionsInputMsgType that = ((RemoveFolderPermissionsInputMsgType) object);
        {
            Integer lhsFolderId;
