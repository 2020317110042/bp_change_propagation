...
/**
 * <p>ExportFragmentResultType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ExportFragmentResultType">
 *   &lt;complexContent>
...
@XmlType(name = "ExportFragmentResultType", propOrder = {
    "_native",
    "message"
})
public class ExportFragmentResultType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ExportFragmentResultType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ExportFragmentResultType that = ((ExportFragmentResultType) object);
        {
