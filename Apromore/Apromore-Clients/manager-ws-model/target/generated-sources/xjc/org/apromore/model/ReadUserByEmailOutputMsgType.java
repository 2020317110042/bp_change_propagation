...
/**
 * <p>ReadUserByEmailOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ReadUserByEmailOutputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "ReadUserByEmailOutputMsgType", propOrder = {
    "result",
    "user"
})
public class ReadUserByEmailOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ReadUserByEmailOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ReadUserByEmailOutputMsgType that = ((ReadUserByEmailOutputMsgType) object);
        {
