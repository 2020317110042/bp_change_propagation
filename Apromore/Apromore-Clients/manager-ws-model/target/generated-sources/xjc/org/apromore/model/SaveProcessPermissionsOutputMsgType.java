...
/**
 * <p>SaveProcessPermissionsOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="SaveProcessPermissionsOutputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "SaveProcessPermissionsOutputMsgType", propOrder = {
    "result"
})
public class SaveProcessPermissionsOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SaveProcessPermissionsOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SaveProcessPermissionsOutputMsgType that = ((SaveProcessPermissionsOutputMsgType) object);
        {
