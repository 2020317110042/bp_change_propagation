...
/**
 * <p>PluginParameter complex type的 Java 类。
 * 
...
@XmlType(name = "PluginParameter", propOrder = {
    "value"
})
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            Boolean theIsMandatory;
            theIsMandatory = this.isIsMandatory();
            strategy.appendField(locator, this, "isMandatory", buffer, theIsMandatory);
        }
        {
            String theCategory;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PluginParameter)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final PluginParameter that = ((PluginParameter) object);
        {
            Object lhsValue;
        ...
        {
            Boolean lhsIsMandatory;
            lhsIsMandatory = this.isIsMandatory();
            Boolean rhsIsMandatory;
            rhsIsMandatory = that.isIsMandatory();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "isMandatory", lhsIsMandatory), LocatorUtils.property(thatLocator, "isMandatory", rhsIsMandatory), lhsIsMandatory, rhsIsMandatory)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            Boolean theIsMandatory;
            theIsMandatory = this.isIsMandatory();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "isMandatory", theIsMandatory), currentHashCode, theIsMandatory);
        }
        {
            String theCategory;
            theCategory = this.getCategory();
