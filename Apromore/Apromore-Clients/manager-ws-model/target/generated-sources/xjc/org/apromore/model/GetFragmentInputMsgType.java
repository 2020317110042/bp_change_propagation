...
/**
 * <p>GetFragmentInputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="GetFragmentInputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "GetFragmentInputMsgType", propOrder = {
    "fragmentId"
})
public class GetFragmentInputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetFragmentInputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetFragmentInputMsgType that = ((GetFragmentInputMsgType) object);
        {
            int lhsFragmentId;
