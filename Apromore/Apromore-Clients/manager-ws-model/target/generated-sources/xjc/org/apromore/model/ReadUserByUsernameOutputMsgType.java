...
/**
 * <p>ReadUserByUsernameOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ReadUserByUsernameOutputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "ReadUserByUsernameOutputMsgType", propOrder = {
    "result",
    "user"
})
public class ReadUserByUsernameOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ReadUserByUsernameOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ReadUserByUsernameOutputMsgType that = ((ReadUserByUsernameOutputMsgType) object);
        {
