...
/**
 * <p>GetSubFoldersInputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="GetSubFoldersInputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "GetSubFoldersInputMsgType")
public class GetSubFoldersInputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetSubFoldersInputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetSubFoldersInputMsgType that = ((GetSubFoldersInputMsgType) object);
        {
            String lhsUserId;
