...
/**
 * <p>ResetUserPasswordOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ResetUserPasswordOutputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "ResetUserPasswordOutputMsgType", propOrder = {
    "result",
    "success"
})
public class ResetUserPasswordOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ResetUserPasswordOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ResetUserPasswordOutputMsgType that = ((ResetUserPasswordOutputMsgType) object);
        {
