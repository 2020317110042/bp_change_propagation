...
/**
 * <p>CreateUserOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="CreateUserOutputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "CreateUserOutputMsgType", propOrder = {
    "user",
    "result"
})
public class CreateUserOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CreateUserOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CreateUserOutputMsgType that = ((CreateUserOutputMsgType) object);
        {
            UserType lhsUser;
