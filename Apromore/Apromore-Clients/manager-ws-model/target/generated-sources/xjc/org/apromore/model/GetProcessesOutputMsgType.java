...
/**
 * <p>GetProcessesOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="GetProcessesOutputMsgType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="Result" type="{urn:qut-edu-au:schema:apromore:manager}ResultType"/>
 *         &lt;element name="Processes" type="{urn:qut-edu-au:schema:apromore:manager}ProcessSummariesType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "GetProcessesOutputMsgType", propOrder = {
    "result",
    "processes"
})
public class GetProcessesOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    protected ProcessSummariesType processes;
     ...
     *     
     */
    public ProcessSummariesType getProcesses() {
        return processes;
    }
     ...
     *     
     */
    public void setProcesses(ProcessSummariesType value) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            ProcessSummariesType theProcesses;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetProcessesOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetProcessesOutputMsgType that = ((GetProcessesOutputMsgType) object);
        {
        ...
        {
            ProcessSummariesType lhsProcesses;
            lhsProcesses = this.getProcesses();
            ProcessSummariesType rhsProcesses;
