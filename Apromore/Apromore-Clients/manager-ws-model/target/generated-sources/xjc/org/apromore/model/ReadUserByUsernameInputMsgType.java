...
/**
 * <p>ReadUserByUsernameInputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ReadUserByUsernameInputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "ReadUserByUsernameInputMsgType")
public class ReadUserByUsernameInputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ReadUserByUsernameInputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ReadUserByUsernameInputMsgType that = ((ReadUserByUsernameInputMsgType) object);
        {
            String lhsUsername;
