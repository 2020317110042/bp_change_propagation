...
/**
 * <p>GetFolderGroupsOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="GetFolderGroupsOutputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "GetFolderGroupsOutputMsgType", propOrder = {
    "result",
    "groups"
})
public class GetFolderGroupsOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetFolderGroupsOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetFolderGroupsOutputMsgType that = ((GetFolderGroupsOutputMsgType) object);
        {
