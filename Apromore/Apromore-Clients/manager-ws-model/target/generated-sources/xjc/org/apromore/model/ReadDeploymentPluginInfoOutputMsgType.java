...
/**
 * <p>ReadDeploymentPluginInfoOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ReadDeploymentPluginInfoOutputMsgType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="Result" type="{urn:qut-edu-au:schema:apromore:manager}ResultType"/>
 *         &lt;element name="PluginInfo" type="{urn:qut-edu-au:schema:apromore:manager}PluginInfo" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ReadDeploymentPluginInfoOutputMsgType", propOrder = {
    "result",
    "pluginInfo"
})
public class ReadDeploymentPluginInfoOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ReadDeploymentPluginInfoOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ReadDeploymentPluginInfoOutputMsgType that = ((ReadDeploymentPluginInfoOutputMsgType) object);
        {
