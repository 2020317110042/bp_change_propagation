...
/**
 * <p>DeployProcessOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="DeployProcessOutputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "DeployProcessOutputMsgType", propOrder = {
    "result",
    "message"
})
public class DeployProcessOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DeployProcessOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DeployProcessOutputMsgType that = ((DeployProcessOutputMsgType) object);
        {
