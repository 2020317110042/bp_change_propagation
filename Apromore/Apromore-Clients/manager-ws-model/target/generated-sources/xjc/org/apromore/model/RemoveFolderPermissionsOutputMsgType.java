...
/**
 * <p>RemoveFolderPermissionsOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="RemoveFolderPermissionsOutputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "RemoveFolderPermissionsOutputMsgType", propOrder = {
    "result"
})
public class RemoveFolderPermissionsOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RemoveFolderPermissionsOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final RemoveFolderPermissionsOutputMsgType that = ((RemoveFolderPermissionsOutputMsgType) object);
        {
