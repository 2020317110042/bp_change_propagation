...
/**
 * <p>UpdateFolderInputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="UpdateFolderInputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "UpdateFolderInputMsgType")
public class UpdateFolderInputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UpdateFolderInputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UpdateFolderInputMsgType that = ((UpdateFolderInputMsgType) object);
        {
            Integer lhsFolderId;
