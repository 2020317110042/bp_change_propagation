...
/**
 * <p>AddProcessToFolderInputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="AddProcessToFolderInputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "AddProcessToFolderInputMsgType")
public class AddProcessToFolderInputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AddProcessToFolderInputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AddProcessToFolderInputMsgType that = ((AddProcessToFolderInputMsgType) object);
        {
