...
/**
 * <p>UpdateFolderOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="UpdateFolderOutputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "UpdateFolderOutputMsgType", propOrder = {
    "result"
})
public class UpdateFolderOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UpdateFolderOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UpdateFolderOutputMsgType that = ((UpdateFolderOutputMsgType) object);
        {
