...
/**
 * <p>ReadProcessSummariesInputMsgType complex type的 Java 类。
 * 
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ReadProcessSummariesInputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ReadProcessSummariesInputMsgType that = ((ReadProcessSummariesInputMsgType) object);
        {
            Integer lhsFolderId;
