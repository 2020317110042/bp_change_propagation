...
/**
 * <p>ExportFormatResultType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ExportFormatResultType">
 *   &lt;complexContent>
...
@XmlType(name = "ExportFormatResultType", propOrder = {
    "_native",
    "message"
})
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ExportFormatResultType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ExportFormatResultType that = ((ExportFormatResultType) object);
        {
