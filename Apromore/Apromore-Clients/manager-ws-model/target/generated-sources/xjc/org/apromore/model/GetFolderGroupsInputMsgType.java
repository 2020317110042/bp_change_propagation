...
/**
 * <p>GetFolderGroupsInputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="GetFolderGroupsInputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "GetFolderGroupsInputMsgType")
public class GetFolderGroupsInputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetFolderGroupsInputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetFolderGroupsInputMsgType that = ((GetFolderGroupsInputMsgType) object);
        {
            Integer lhsFolderId;
