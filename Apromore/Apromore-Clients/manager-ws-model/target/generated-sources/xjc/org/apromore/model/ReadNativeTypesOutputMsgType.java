...
/**
 * <p>ReadNativeTypesOutputMsgType complex type的 Java 类。
 * 
 ...
 *         &lt;element name="NativeTypes" type="{urn:qut-edu-au:schema:apromore:manager}NativeTypesType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            NativeTypesType theNativeTypes;
            theNativeTypes = this.getNativeTypes();
            strategy.appendField(locator, this, "nativeTypes", buffer, theNativeTypes);
        }
        return buffer;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ReadNativeTypesOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ReadNativeTypesOutputMsgType that = ((ReadNativeTypesOutputMsgType) object);
        {
        ...
        {
            NativeTypesType lhsNativeTypes;
            lhsNativeTypes = this.getNativeTypes();
            NativeTypesType rhsNativeTypes;
            rhsNativeTypes = that.getNativeTypes();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "nativeTypes", lhsNativeTypes), LocatorUtils.property(thatLocator, "nativeTypes", rhsNativeTypes), lhsNativeTypes, rhsNativeTypes)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            NativeTypesType theNativeTypes;
            theNativeTypes = this.getNativeTypes();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "nativeTypes", theNativeTypes), currentHashCode, theNativeTypes);
        }
