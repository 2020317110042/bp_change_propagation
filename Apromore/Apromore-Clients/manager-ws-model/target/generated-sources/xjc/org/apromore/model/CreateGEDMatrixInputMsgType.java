...
/**
 * <p>CreateGEDMatrixInputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="CreateGEDMatrixInputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "CreateGEDMatrixInputMsgType")
public class CreateGEDMatrixInputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CreateGEDMatrixInputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CreateGEDMatrixInputMsgType that = ((CreateGEDMatrixInputMsgType) object);
        {
            String lhsEmpty;
