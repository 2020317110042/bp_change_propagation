...
/**
 * <p>SearchGroupsOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="SearchGroupsOutputMsgType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="Result" type="{urn:qut-edu-au:schema:apromore:manager}ResultType"/>
 *         &lt;element name="Groups" type="{urn:qut-edu-au:schema:apromore:manager}GroupType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SearchGroupsOutputMsgType", propOrder = {
    "result",
    "groups"
})
public class SearchGroupsOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SearchGroupsOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SearchGroupsOutputMsgType that = ((SearchGroupsOutputMsgType) object);
        {
        ...
        {
            List<GroupType> lhsGroups;
            lhsGroups = this.getGroups();
            List<GroupType> rhsGroups;
