...
/**
 * <p>GetProcessGroupsOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="GetProcessGroupsOutputMsgType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="Result" type="{urn:qut-edu-au:schema:apromore:manager}ResultType"/>
 *         &lt;element name="Groups" type="{urn:qut-edu-au:schema:apromore:manager}GroupAccessType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "GetProcessGroupsOutputMsgType", propOrder = {
    "result",
    "groups"
})
public class GetProcessGroupsOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    protected List<GroupAccessType> groups;
     ...
     * 
     */
    public List<GroupAccessType> getGroups() {
        if (groups == null) {
            groups = new ArrayList<GroupAccessType>();
        }
        return this.groups;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            List<GroupAccessType> theGroups;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetProcessGroupsOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetProcessGroupsOutputMsgType that = ((GetProcessGroupsOutputMsgType) object);
        {
        ...
        {
            List<GroupAccessType> lhsGroups;
            lhsGroups = this.getGroups();
            List<GroupAccessType> rhsGroups;
