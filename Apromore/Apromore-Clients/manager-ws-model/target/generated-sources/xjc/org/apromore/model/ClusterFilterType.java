...
/**
 * <p>ClusterFilterType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ClusterFilterType">
 *   &lt;complexContent>
...
@XmlType(name = "ClusterFilterType", propOrder = {
    "minClusterSize",
    "maxClusterSize",
    "minAvgFragmentSize",
    "maxAvgFragmentSize",
...
public class ClusterFilterType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ClusterFilterType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ClusterFilterType that = ((ClusterFilterType) object);
        {
