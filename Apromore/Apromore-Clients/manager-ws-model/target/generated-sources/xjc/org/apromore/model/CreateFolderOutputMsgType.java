...
/**
 * <p>CreateFolderOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="CreateFolderOutputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "CreateFolderOutputMsgType", propOrder = {
    "result"
})
public class CreateFolderOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CreateFolderOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CreateFolderOutputMsgType that = ((CreateFolderOutputMsgType) object);
        {
