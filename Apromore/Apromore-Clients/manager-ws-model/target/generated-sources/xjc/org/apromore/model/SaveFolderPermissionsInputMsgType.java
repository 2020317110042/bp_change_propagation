...
/**
 * <p>SaveFolderPermissionsInputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="SaveFolderPermissionsInputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "SaveFolderPermissionsInputMsgType")
public class SaveFolderPermissionsInputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SaveFolderPermissionsInputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SaveFolderPermissionsInputMsgType that = ((SaveFolderPermissionsInputMsgType) object);
        {
            Integer lhsFolderId;
