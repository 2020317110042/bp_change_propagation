...
/**
 * <p>GetSubFoldersOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="GetSubFoldersOutputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "GetSubFoldersOutputMsgType", propOrder = {
    "result",
    "folders"
})
public class GetSubFoldersOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetSubFoldersOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetSubFoldersOutputMsgType that = ((GetSubFoldersOutputMsgType) object);
        {
