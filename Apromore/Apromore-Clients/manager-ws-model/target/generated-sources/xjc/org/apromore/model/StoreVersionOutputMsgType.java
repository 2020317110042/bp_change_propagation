...
/**
 * <p>StoreVersionOutputMsgType complex type的 Java 类。
 * 
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof StoreVersionOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final StoreVersionOutputMsgType that = ((StoreVersionOutputMsgType) object);
        {
