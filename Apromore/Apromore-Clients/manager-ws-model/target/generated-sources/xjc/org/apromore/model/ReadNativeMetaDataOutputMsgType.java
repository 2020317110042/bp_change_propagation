...
/**
 * <p>ReadNativeMetaDataOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ReadNativeMetaDataOutputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "ReadNativeMetaDataOutputMsgType", propOrder = {
    "result",
    "nativeMetaData"
})
public class ReadNativeMetaDataOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ReadNativeMetaDataOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ReadNativeMetaDataOutputMsgType that = ((ReadNativeMetaDataOutputMsgType) object);
        {
