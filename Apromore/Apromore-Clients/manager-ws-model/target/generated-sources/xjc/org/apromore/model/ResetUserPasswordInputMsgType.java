...
/**
 * <p>ResetUserPasswordInputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ResetUserPasswordInputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "ResetUserPasswordInputMsgType")
public class ResetUserPasswordInputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ResetUserPasswordInputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ResetUserPasswordInputMsgType that = ((ResetUserPasswordInputMsgType) object);
        {
            String lhsUsername;
