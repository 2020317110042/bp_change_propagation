...
/**
 * <p>AddProcessToFolderOutputMsgType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="AddProcessToFolderOutputMsgType">
 *   &lt;complexContent>
...
@XmlType(name = "AddProcessToFolderOutputMsgType", propOrder = {
    "result"
})
public class AddProcessToFolderOutputMsgType
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AddProcessToFolderOutputMsgType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AddProcessToFolderOutputMsgType that = ((AddProcessToFolderOutputMsgType) object);
        {
